    ...
    <div>
      ...
      <div className="number-div">
        ...
        <p className="text">
          ...
          acute issue will be enough, versus, others may need consistent, weekly
          sessions for months or years depending on their needs. We can discuss
          this in further detail to ensure you are receiving the support that
          you are looking for. ​
        </p>
      </div>
